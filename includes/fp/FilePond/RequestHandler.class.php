...
class RequestHandler
{
    ...
    private static function getSecurePath($path) {
        return '/xampp/htdocs/woopainting/wp-content/uploads/orders' . DIRECTORY_SEPARATOR . basename($path) . DIRECTORY_SEPARATOR;
        //return '/var/www/woopainting.com/wp-content/uploads/orders' . DIRECTORY_SEPARATOR . basename($path) . DIRECTORY_SEPARATOR;
        //return plugin_dir_path( __FILE__ ). DIRECTORY_SEPARATOR.'includes/fp/';
        //return '/xampp/htdocs/woopainting/wp-content/plugins/woopainting/includes/fp/uploads/';
    }
